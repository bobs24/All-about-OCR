...
dictionary = dict(
    dict_file=
    '/content/mmocr/configs/textrecog/svtr/../../../dicts/lower_english_digits.txt',
    type='Dictionary',
    with_padding=True,
    with_unknown=True)
env_cfg = dict(
...
icdar2015_1811_textrecog_test = dict(
    ...
    data_root='/content/dataset-rec',
    pipeline=None,
    test_mode=True,
    type='OCRDataset')
icdar2015_textrecog_data_root = '/content/dataset-rec'
...
work_dir = '/content/work_dir/TextRecognition_svtr_training'
