...
icdar2015_textdet_data_root = '/content/dataset-det'
icdar2015_textdet_test = dict(
    ann_file='textdet_test.json',
    data_root='/content/dataset-det',
    pipeline=[
...
train_cfg = dict(max_epochs=70, type='EpochBasedTrainLoop', val_interval=10)
...
work_dir = '/content/work_dir/TextDetection_dbnet_training'
